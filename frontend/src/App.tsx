            ...
            {isSidebarModelPickerOpen && (
              <div
                style={{
                  ...
                  borderLeft: `1px solid ${getModelColor(selectedModel)}66`,
                  borderRight: `1px solid ${getModelColor(selectedModel)}66`,
                  borderBottom: `1px solid ${getModelColor(selectedModel)}66`,
