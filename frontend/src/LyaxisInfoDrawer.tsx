...
import { X, ShieldCheck, BookOpen, Layers, Lock, Cpu, Sparkles, Terminal, Flame, Zap, CheckCircle2, AlertCircle, FileText, GraduationCap, Presentation } from 'lucide-react';
          ...
          {activeTab === 'ecosystem' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              {[
                ...
                { name: 'LYAXIS Canvas', type: 'Diseñador Visual', desc: 'Presentaciones interactivas en vivo, láminas estilo Canva y exportación a PDF.', icon: <Presentation size={16} color="#8B5CF6" />, tag: 'Slide Decks' },
